...
def evalimage(net:Yolact, path:str, save_path:str=None):
    ...
    torch.onnx.export(net, dummy_input, "yolact.onnx", verbose=True, opset_version=11)
...
#python eval.py --trained_model=weights/yolact_darknet53_54_800000.pth --score_threshold=0.3
# --top_k=100 --cuda=False --image=dog.jpg
